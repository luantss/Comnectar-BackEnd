...
CREATE TABLE IF NOT EXISTS `db_comnectar`.`tb_produto` (
  ...
  `tb_categoria_id_produto` BIGINT NOT NULL,
  `tb_usuario_id_produto` BIGINT NOT NULL,
  PRIMARY KEY (`id_produto`),
  INDEX `fk_tb_produto_tb_categoria_idx` (`tb_categoria_id_produto` ASC) VISIBLE,
  INDEX `fk_tb_produto_tb_usuario1_idx` (`tb_usuario_id_produto` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_tb_produto_tb_usuario1`
    FOREIGN KEY (`tb_usuario_id_produto`)
